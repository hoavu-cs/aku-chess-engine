...
./fastchess.exe  -engine cmd=aku_experiment name=NewAku -engine cmd=aku name=OldAku -each tc=60+0.6 -rounds 10000 -repeat -concurrency 4 -openings file=imbalanced_book.epd format=epd -sprt elo0=0 elo1=5 alpha=0.05 beta=0.05
