...
#include <fstream>
#include "npy.hpp"
#include "../chess.hpp"  // Ensure correct path
...
private:
    ...
    void loadModel() {
        ...
        model.W2 = loadMatrix("nnue_weights/fc2.weight.npy", 128, 256);
        model.B2 = loadVector("nnue_weights/fc2.bias.npy", 128);
        
        model.W3 = loadMatrix("nnue_weights/fc3.weight.npy", 1, 128);
