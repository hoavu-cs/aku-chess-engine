This is a fun side project to test several searching algorithms. There were certainly several silly bugs in the implementation and logic in the past. I'm also too lazy to write my own movegen at the moment.
...
The engine currently plays rapid chess at an estimated 3100-3300 ELO and may vary greatly because I often make random changes to test new ideas. The main goal is to improve the strength through exploring new ideas in the search algorithm. In my opinion, there should be a clean search algorithm to replace or encapsulate multiple heuristics that take a lot of manual effort in finetuning (I prefer simplicity).
