...
The engine currently plays rapid chess at an estimated 3100-3300 CCRL ELO (If I have to guess, it is probably above 3200 and approaching/surpassing 3300 based on the games against rated engines. But it's not too important at the moment). The main goal is to see if I can improve the strength through sketching, sampling, or anything that I can come up with. Hopefully, there is a clean algorithm to replace or encapsulate multiple heuristics that requires less finetuning. 
