...
**Strength**. The engine currently plays rapid chess at an estimated 3100-3400 CCRL ELO. If I have to guess, it is probably somewhere between 3200-3400 based on the games against rated engines on Lichess and local tests. It is also quite stronger on multiple threads.
