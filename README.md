This is just a fun side project that I'm playing (to test several searching algorithms); it's not an attempt at being competitive. There are certainly several silly bugs in implementation and logic.
